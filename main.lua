...
local function render_level_select()
    renderBackground()
    local x, y = 100, 100
    for name, opponent in pairs(buttons.level_select) do
        opponent:draw(x, y)
        x = x + 400
    end
end
